...
<script type="text/javascript">
		function addCart(){
			...
			location.href="${pageContext.request.contextPath }/addProductToCart.do?pid=${product.pid}&buyNum="+buyNum;
		}
		...
		<div class="row">
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div>
						<a href="${pageContext.request.contextPath }/productListByCid.do?cid=${cid}&currentPage=${currentPage}">返回列表页面</a>
					</div>
