...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			$(function(){
				$.post(
					"${pageContext.request.contextPath}/admin/findAllCategory.do",	
					function(data){
						//[{"cid":"xxx","cname":"xxx"},{},{}...]
						var content="";
	...
	<body>
		<!--  -->
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/admin/addProduct.do" method="post" enctype="multipart/form-data">
			&nbsp;
