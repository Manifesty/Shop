...
<body>
	...
	<div class="container">
				...
				<c:forEach items="${order.orderItems}" var="orderItem">
						...
						<tr class="active">
							<td width="60" width="40%"><input type="hidden" name="id"
								value="22"> <img src="${pageContext.request.contextPath}/${orderItem.product.pimage}" width="70" height="60"></td>
		...
		<div>
			<hr />
			<form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath}/confirmOrder.do" method="post"
