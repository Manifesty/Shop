...
<html>
	<head>
		...
		<script type="text/javascript">
			function delProFromCart(pid){
				if(confirm("是否删除？")){
					location.href="${pageContext.request.contextPath}/delProFromCart.do?pid="+pid;
			...
			function clearCart(){
				if(confirm("是否清空购物车？")){
					location.href="${pageContext.request.contextPath}/clearCart.do";
			...
			<div class="container">
				...
				<div style="margin-right:130px;">
					...
					<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
						...
						<a href="${pageContext.request.contextPath }/privilege/submitOrder.do">
	...
	<c:if test="${empty cart.cartItems }">
			<div>
					<image src="${pageContext.request.contextPath }/images/cart-empty.png">
