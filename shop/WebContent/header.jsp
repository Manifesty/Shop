...
<div class="container-fluid">
	...
	<div class="col-md-3" style="padding-top:20px">
		<ol class="list-inline">
			...
			<li><a href="${pageContext.request.contextPath }/privilege/myOrder.do">我的订单</a></li>
		</ol>
	</div>
</div>
				...
				$.post(
						...
						function(data){
							...
							for(var i=0;i<data.length;i++){
								content+="<li><a href='${pageContext.request.contextPath}/productListByCid.do?cid="+data[i].cid+"'>"+data[i].cname+"</a></li>";
							}
